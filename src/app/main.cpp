...
int main(void)
{
    ...
    adcConfig[0].InitSingle(Board.GetPin(18));
    adcConfig[1].InitSingle(Board.GetPin(19));
    adcConfig[2].InitSingle(Board.GetPin(20));
    adcConfig[3].InitSingle(Board.GetPin(21));
